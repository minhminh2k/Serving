...
parser.add_argument("--triton_url", default="0.0.0.0:8112")
...
def generate(prompt):
    ...
    response = client.infer(
        model_name="stable_diffusion_pipeline", inputs=[input_text], outputs=[output_img]
    )
...
with gr.Blocks() as app:
    ...
    img_output = gr.Image(height=512, width=512)
