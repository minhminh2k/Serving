...
def convert_models(
    ...
    print(f"Shape of text encoder: {num_tokens}, {text_hidden_size}")
    ...
    print(f"Shape of text input: {text_input.input_ids.shape}")
...
# python scripts/stable_diffusion_v1_4/sb_pipeline_unet.py --output_path onnx_sb/ 